...
description: Add a tested Fastify feature and record its API contract.
---
...
3. Add a route plugin, service logic, and Prisma persistence only as needed.
4. Add a Prisma migration when the schema changes.
5. Add focused inject-based tests; run `npm test` and `npm run build`.
